          ...
          <div className="row g-8">
            <div className="col-6 col-md-4 col-lg-3">
              <div className="text-center mb-4">
                <div className="theme-img corner-tl">
                  <img
                    src="/src/assets/images/theme/theme01.jpg"
                    alt="theme01"
                  />
                  <div className="theme-text h3">工業</div>
                </div>
              </div>
            </div>
            ...
            <div className="col-6 col-md-4 col-lg-3">
              <div className="text-center mb-4">
                <div className="theme-img">
                  <img
                    src="/src/assets/images/theme/theme02.jpg"
                    alt="theme02"
                  />
                  <div className="theme-text h3">義大利現代</div>
                </div>
              </div>
            </div>
            ...
            <div className="col-6 col-md-4 col-lg-3">
              <div className="text-center mb-4">
                <div className="theme-img">
                  <img
                    src="/src/assets/images/theme/theme03.jpg"
                    alt="theme03"
                  />
                  <div className="theme-text h3">現代北歐</div>
                </div>
              </div>
            </div>
            ...
            <div className="col-6 col-md-4 col-lg-3">
              <div className="text-center mb-4">
                <div className="theme-img corner-tr">
                  <img
                    src="/src/assets/images/theme/theme04.jpg"
                    alt="theme04"
                  />
                  <div className="theme-text h3">日式無印</div>
                </div>
              </div>
            </div>
            ...
            <div className="col-6 col-md-4 col-lg-3">
              <div className="text-center mb-4">
                <div className="theme-img corner-bl">
                  <img
                    src="/src/assets/images/theme/theme05.jpg"
                    alt="theme05"
                  />
                  <div className="theme-text h3">現代簡約風</div>
                </div>
              </div>
            </div>
            ...
            <div className="col-6 col-md-4 col-lg-3">
              <div className="text-center mb-4">
                <div className="theme-img">
                  <img
                    src="/src/assets/images/theme/theme06.jpg"
                    alt="theme06"
                  />
                  <div className="theme-text h3">世紀中期</div>
                </div>
              </div>
            </div>
            ...
            <div className="col-6 col-md-4 col-lg-3">
              <div className="text-center mb-4">
                <div className="theme-img">
                  <img
                    src="/src/assets/images/theme/theme07.jpg"
                    alt="theme07"
                  />
                  <div className="theme-text h3">療癒奶油</div>
                </div>
              </div>
            </div>
            ...
            <div className="col-6 col-md-4 col-lg-3">
              <div className="text-center mb-4">
                <div className="theme-img corner-br">
                  <img
                    src="/src/assets/images/theme/theme08.jpg"
                    alt="theme08"
                  />
                  <div className="theme-text h3">宅寂</div>
                </div>
              </div>
            </div>
          </div>
