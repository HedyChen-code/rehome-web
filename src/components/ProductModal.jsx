  ...
  const updateProduct = async (id) => {
    ...
    const productData = {
      data: {
        ...
        size: tempData.size,
        condition_level: tempData.condition_level,
        ...
        <div className="modal-content border-0">
          ...
          <div className="modal-body">
            {modalType === 'delete' ? (
              ...
              <table className="table table-bordered border-gray-75 align-middle">
                <tbody>
                  {/* 產品名稱 */}
                  <tr>
                    <th className="bg-primary-30">產品名稱</th>
                    <td colSpan="3">
                      <input
                        type="text"
                  ...
                  {/* 類別 / 風格 */}
                  <tr>
                    <th className="bg-primary-30">類別</th>
                    <td>
                      <select
                    ...
                    <th className="bg-primary-30">風格</th>
                    <td>
                      <select
                        className="form-select"
                        name="style"
                  ...
                  {/* 產品描述 / 顏色 */}
                  <tr>
                    <th className="bg-primary-30">產品描述</th>
                    <td>
                      <input
                        type="text"
                        className="form-control"
                    ...
                    <th className="bg-primary-30">顏色</th>
                    <td>
                      <input
                        type="text"
                        className="form-control"
                  ...
                  {/* 材料 */}
                  <tr>
                    <th className="bg-primary-30">材料</th>
                    <td colSpan="3">
                      {tempData.material?.map((mat, index) => (
                  ...
                  {/* 價格 */}
                  <tr>
                    <th className="bg-primary-30">原始價格</th>
                    <td>
                      <input
                        type="number"
                        className="form-control"
                    ...
                    <th className="bg-primary-30">售價</th>
                    <td>
                      <input
                        type="number"
                        className="form-control"
                  ...
                  {/* 數量 / 單位 */}
                  <tr>
                    <th className="bg-primary-30">數量</th>
                    <td>
                      <input
                        type="number"
                        className="form-control"
                    ...
                    <th className="bg-primary-30">單位</th>
                    <td>
                      <input
                        type="text"
                        className="form-control"
                  ...
                  {/* 尺寸 */}
                  <tr>
                    <th className="bg-primary-30">尺寸 (mm)</th>
                    <td colSpan="3">
                      <div className="d-flex gap-2">
                        <input
                          ...
                          onChange={(e) =>
                            setTempData((prev) => ({
                              ...prev,
                              size: { ...prev.size, w: e.target.value },
                            }))
                          }
                        />
                        <input
                          ...
                          onChange={(e) =>
                            setTempData((prev) => ({
                              ...prev,
                              size: { ...prev.size, d: e.target.value },
                            }))
                          }
                        />
                        <input
                          ...
                          onChange={(e) =>
                            setTempData((prev) => ({
                              ...prev,
                              size: { ...prev.size, h: e.target.value },
                            }))
                          }
                        />
                        <input
                  ...
                  {/* 商品程度 */}
                  <tr>
                    <th className="bg-primary-30">商品程度</th>
                    <td>
                      <select
                        className="form-select"
                        name="condition_level"
                        value={tempData.condition_level || ''}
                        onChange={handleEditProductChange}
                      >
                        <option value="">請選擇</option>
                    ...
                    <th className="bg-primary-30">上架狀態</th>
                    <td>
                      <select
                        className="form-select"
                        name="is_enabled"
                  ...
                  {/* 新品 / 推薦 */}
                  <tr>
                    <th className="bg-primary-30">新品狀態</th>
                    <td>
                      <select
                        className="form-select"
                    ...
                    <th className="bg-primary-30">推薦狀態</th>
                    <td>
                      <select
                        className="form-select"
                        ...
                        onChange={(e) =>
                          setTempData((prev) => ({
                            ...prev,
                            is_is_recommend: Number(e.target.value),
                          }))
                        }
                      >
                        <option value="1">是</option>
                  ...
                  {/* 商品故事 */}
                  <tr>
                    <th className="bg-primary-30">故事標題</th>
                    <td colSpan="3">
                      <input
                        type="text"
                        className="form-control"
                  ...
                  <tr>
                    <th className="bg-primary-30">故事內容</th>
                    <td colSpan="3">
                      <textarea
                        className="form-control"
                        rows="3"
                  ...
                  {/* 上傳圖片 */}
                  <tr>
                    <th className="bg-primary-30">上傳圖片</th>
                    <td colSpan="3">
                      <input
                        type="file"
                        accept=".jpg,.jpeg,.png"
                  ...
                  {/* 主照片 */}
                  <tr>
                    <th className="bg-primary-30">主照片網址</th>
                    <td colSpan="3">
                      <input
                        type="text"
                        className="form-control"
