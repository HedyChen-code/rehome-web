  ...
  return (
    <>
      <section className="guide_sm_bg custom-container ">
        <div className="container">
          <div className="guide_bg d-block">
            <p className="text-white mb-8 fs-lg-2 fs-5">
              每件物品，都值得再被生活一次
            </p>
            <p className="text-grey mb-8 fs-lg-5 fs-8">
              讓舊物不老，
              <br /> 讓故事延續，
              <br /> 讓物回家， <br /> 讓生活更溫柔。
            </p>
            <p className="text-primary-70 fs-lg-5 fs-7">
              物拾 Re:home <br /> 拾起物的故事，延續家的風景。
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container my-lg-16 my-12 position-relative process-sm-bg">
        ...
        <p className="fs-lg-5 text-center text-gray-50 mb-12">
          讓物回家，讓生活更溫柔。
        </p>
        <div className="process-bg d-block">
          <div className="d-lg-flex d-block align-items-center justify-content-between mb-9 mb-lg-0">
            <div className="position-relative mb-3 mb-lg-0">
              <span className="fs-lg-6 fs-7 text-white bg-primary-70 px-5 py-2 rounded-pill">
                事前準備
              </span>
              <p className="fs-lg-3 fs-4 mt-4 mb-lg-8 mb-3 text-primary-70">
                為下一段生活，整理一下
              </p>
              <p className="text-grey  fs-lg-5  fs-7">
                在物件啟程前，邀請你為它做一點溫柔的準備。 <br />
                簡單清潔、拍下清楚的照片，或寫下它陪伴你的故事與使用狀態。{' '}
                <br />
                這些細節，會成為下一位生活主人理解它的第一扇門。
              </p>
          ...
          <div className="d-lg-flex d-block align-items-center justify-content-between mb-9 mb-lg-0">
            ...
            <div className="position-relative  mb-3 mb-lg-0">
              ...
              <p className="text-grey fs-lg-5  fs-7">
                聯繫 物拾 Re:home 後，我們會向你清楚說明平台的媒合原則： <br />
                包含適合上架的家具類型、風格分類方式，以及價格建議邏輯。 <br />
                所有流程透明清楚，沒有壓力，也沒有被低估的擔心。
              </p>
          ...
          <div className="d-lg-flex d-block align-items-center justify-content-between mb-9 mb-lg-0">
            <div className="position-relative  mb-3 mb-lg-0">
              ...
              <p className="text-grey fs-lg-5  fs-7">
                我們會仔細看看這件家具的狀態與背景， <br />
                從使用年限、保存狀況、設計風格、材質細節， <br />
                到它是否仍能融入下一個家的風景， <br />
                給出一個尊重物件本身、也對你誠實的建議價值。
              </p>
      ...
      <section className="bg-primary-90 rounded-3 ">
        <div className="container py-16">
          <div className="position-relative d-flex justify-content-center align-items-center mb-10">
            <p className="fs-lg-2  fs-4 text-center mb-10 text-white  z-1">
              收購 / 媒合常見 FAQ
            </p>
            <img
            ...
            <div className="accordion w-100 me-8" id="accordionExample">
              <div className="accordion-item mb-8 border-0 bg-transparent">
                <h2 className="accordion-header " id="headingOne">
                  <button
                    className="accordion-button collapsed rounded-pill bg-white mb-4 text-dark fs-6 "
                    type="button"
                ...
                >
                  <div className="accordion-body bg-primary-10 rounded-4 mb-4">
                    <p className="fs-7">
                      我們主要媒合仍具使用價值、結構完整、外觀保存良好的家具。特別歡迎具有風格特色、材質溫潤（如木質、設計款）的物件。即使有歲月痕跡，只要安全、可使用，都是我們願意為它尋找新家的對象。
                    </p>
                  </div>
                </div>
              </div>
              <div className="accordion-item mb-8 border-0 bg-transparent">
                ...
                >
                  <div className="accordion-body bg-primary-10 rounded-4 mb-4">
                    <p className="fs-7">
                      不需要。物拾 Re:home
                      相信:使用痕跡不是缺點，而是生活留下的證明。我們更在意的是結構安全、使用狀態，以及是否能融入下一段生活風景
                    </p>
                  </div>
                </div>
              </div>
              <div className="accordion-item mb-8 border-0 bg-transparent">
                ...
                >
                  <div className="accordion-body bg-primary-10 rounded-4 mb-4">
                    <p className="fs-7">
                      有的。由於多數二手家電在超過10年後，可能面臨零件停產、維修困難的情況，特別是變頻類家電，若需要更換主機板或核心零件，往往成本較高，也影響後續使用體驗，因此，
                      為了確保下一位使用者的安全與安心，我們會視年份、品牌與實際狀況評估是否適合媒合上架
                    </p>
                  </div>
                </div>
              </div>
              <div className="accordion-item mb-8 border-0 bg-transparent">
                ...
                >
                  <div className="accordion-body bg-primary-10 rounded-4 mb-4">
                    <p className="fs-7">
                      目前我們的服務範圍包含：台北市、新北市、桃園地區。若你在其他地區，也歡迎與我們聯絡，我們會盡力協助您評估可能媒合的方式。
                    </p>
                  </div>
                </div>
              </div>
              <div className="accordion-item mb-8 border-0 bg-transparent">
                ...
                >
                  <div className="accordion-body bg-primary-10 rounded-4 mb-4">
                    <p className="fs-7">
                      因為在這裡，你不是把家具「處理掉」，而是替它找一個懂得珍惜的新家。我們不只看價格，也在意物件的去向、風格與故事是否被好好承接。
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="bg-catgory">
        <div className="container py-16">
          <p className="fs-lg-3 text-black text-center mb-4">
            商品類別對應購買與配送服務
          </p>
          <p className="text-primary-50 text-center mb-10 fs-8">
            在物拾，我們相信—— <br />
            一張椅子，不只是椅子；一盞燈，不只照亮房間，也照亮過某段時光。
          </p>
              ...
              <thead>
                <tr>
                  <th scope="col" className="p-0">
                    <div className="p-3 rounded-3 bg-primary-70 text-white fw-normal">
                      家具分類
                    </div>
                  </th>
                  <th scope="col" className="p-0">
              ...
              <tbody>
                <tr>
                  <th scope="row" className="p-0">
                    <div className="p-3 rounded-3 bg-primary-10 text-primary-50 fw-normal">
                      沙發 / 座椅類
                    </div>
                  </th>
                  <td className="p-0">
          ...
          <div className="row d-lg-flex d-block align-items-center justify-content-between py-lg-16 py-12 px-4 px-lg-0">
            <div className="col-12 col-lg-7 sell-form-card px-lg-9 px-8 py-lg-10 py-9">
              ...
              <form className="row" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="col-lg-6 mb-8">
                  <label className="form-label fs-lg-6 mb-3">
                    狀況自評 <span className="text-danger">*</span>
                  </label>
                  <select
                ...
                <div className="mb-8">
                  ...
                  <div className="d-lg-flex d-block align-items-center flex-wrap">
                    <div className="d-flex align-items-center">
                      <label htmlFor="width" className="size-label fs-lg-6">
                        寬
                      </label>
                      <input
                        type="number"
                    ...
                    <div className="d-flex align-items-center">
                      <label htmlFor="depth" className="size-label fs-lg-6">
                        深
                      </label>
                      <input
                        type="number"
                    ...
                    <div className="col-auto px-lg-5 px-0">x</div>
                    <div className="d-flex align-items-center">
                      <label htmlFor="height" className="size-label fs-lg-6">
                        高
                      </label>
                      <input
                        type="number"
                ...
                <div className="mb-9 mt-8">
                  <label className="form-label fs-lg-6 mb-3">
                    照片上傳 <span className="text-danger">*</span>
                  </label>
                  <label
                    htmlFor="formFile"
                  ...
                  >
                    ...
                    <input
                      type="hidden"
                      {...register('image', { required: '請上傳物品照片' })}
                    />
                  </label>
                  {errors.image && (
                    <p
            ...
            <div className="col-12 col-lg-5 align-items-center my-8">
              <div className="ms-4">
                ...
                <p className="fs-lg-5 fs-7 text-gray-90 mb-9">
                  填寫完表單後，
                  <br />
                  我們會在 3–4 個工作日內回覆收購評估與取件方式。
                </p>
                <p className="fs-lg-5 fs-7 text-gray-90 mb-9">
                  ✔ 流程透明
                  <br />✔ 價格公道
