      ...
      return (
        ...
        >
          <div className="col-10 col-md-11">
            ...
            />
            <label className="btn border font-noto label-btn" htmlFor={radioId}>
                            ...
                            <>
                              <div className="vstack gap-3">
                                ...
                                <div className="col-md-8">
                                  ...
                                  />
                                  <label
                                    className="btn border label-btn"
                                    htmlFor="credit"
                                  >
                                    <div className="d-flex justify-content-start align-items-center">
                                      <img
                                        src="images/icon/visa-brandmark.svg"
                                        style={{ width: '40' }}
                                        alt="visa-icon"
                                      />
                                      <p className="text-gray-95 ms-4">
                                        ****1356
                                      </p>
                                    </div>
                                  </label>
                    ...
                    <div>
                      ...
                      <div className="d-flex justify-content-between align-items-center border-top border-3 mb-2 py-2">
                        ...
                        <p className="text-end">
                          {/* 商品總金額與運費加總 */}${' '}
                          {formateNumber(
                            (cartData?.final_total || 0) + shippingFree,
                          )}
                        </p>
                      </div>
                    </div>
