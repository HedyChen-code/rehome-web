            ...
            <div className="d-flex flex-column flex-md-row align-items-center mb-3">
              ...
              <div>
                ...
                <div className="text-center text-md-start mb-8">
                  <a href="#" className="icon-pr me-4" aria-label="Instagram">
                    <img
                      src="/src/assets/images/icon/ig.svg"
                      alt="Instagram"
                    />
                  </a>

                  <a href="#" className="icon-pr me-4" aria-label="Facebook">
                    <img
                  ...
                  <a href="#" className="icon-pr me-4" aria-label="Youtube">
                    <img
                      src="/src/assets/images/icon/yt.svg"
                      alt="Youtube"
                    />
                  </a>
                  ...
                  <a href="#" className="icon-pr me-4" aria-label="X">
                    <img
                      src="/src/assets/images/icon/X.svg"
                      alt="X"
                    />
                  </a>
                </div>
